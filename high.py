...
def job():
 ...
 payload = {
    ...
    'scan_clause': '( {33489} ( [0] 30 minute volume >= [0] 30 minute {custom_indicator_19473_start}"(  volume + 12 candles ago volume + 24 candles ago volume + 36 candles ago volume + 48 candles ago volume ) / 5"{custom_indicator_19473_end} * 2 and latest close > 70 and latest volume > 30000 and latest close <= 2500 ) )'
 ...
 with requests.Session() as s:
    ...
    def get_last_chat_id_and_text(updates):
     ...
     text = table#updates["result"][last_update]["message"]["text"]
